 ...
 */
Redmine.prototype.request = (method, path, params) => {
 ...
 */
Redmine.prototype.issues = (params) => {
  this.request('GET', '/issues.json', params);
};
 ...
 */
Redmine.prototype.get_issue_by_id = (id, params) => {
  if (typeof id !== 'number') throw new Error('Issue ID must be an integer above 0 !');

  this.request('GET', `/issues/${id}.json`, params);
};
 ...
 */
Redmine.prototype.create_issue = (issue) => {
  this.request('POST', '/issues.json', issue);
};
 ...
 */
Redmine.prototype.update_issue = (id, issue) => {
  this.request('PUT', `/issues/${id}.json`, issue);
};
 ...
 */
Redmine.prototype.delete_issue = (id) => {
 ...
 */
Redmine.prototype.add_watcher = (id, params) => {
  if (!params.user_id) throw new Error('user_id (required): id of the user to add as a watcher !');

  this.request('POST', `/issues/${id}/watchers.json`, params);
};
 ...
 */
Redmine.prototype.remove_watcher = (issueId, userId) => {
  this.request('DELETE', `/issues/${issueId}/watchers/${userId}.json`, {});
};
 ...
 */
Redmine.prototype.projects = (params) => {
  this.request('GET', '/projects.json', params);
};
 ...
 */
Redmine.prototype.get_project_by_id = (id, params) => {
  this.request('GET', `/projects/${id}.json`, params);
};
 ...
 */
Redmine.prototype.create_project = (params) => {
  this.request('POST', '/projects.json', params);
};
 ...
 */
Redmine.prototype.update_project = (id, params) => {
  this.request('PUT', `/projects/${id}.json`, params);
};
 ...
 */
Redmine.prototype.delete_project = (id) => {
  this.request('DELETE', `/projects/${id}.json`, {});
};
 ...
 */
Redmine.prototype.users = (params) => {
  this.request('GET', '/users.json', params);
};
 ...
 */
Redmine.prototype.get_user_by_id = (id, params) => {
  this.request('GET', `/users/${id}.json`, params);
};
 ...
 * http://www.redmine.org/projects/redmine/wiki/Rest_Users#GET-2
 */
Redmine.prototype.current_user = (params) => {
  this.request('GET', '/users/current.json', params);
};
 ...
 */
Redmine.prototype.create_user = (params) => {
  this.request('POST', '/users.json', params);
};
 ...
 */
Redmine.prototype.update_user = (id, params) => {
  this.request('PUT', `/users/${id}.json`, params);
};
 ...
 */
Redmine.prototype.delete_user = (id) => {
  this.request('DELETE', `/users/${id}.json`, {});
};
 ...
 */
Redmine.prototype.time_entries = (params) => {
  this.request('GET', '/time_entries.json', params);
};
 ...
 */
Redmine.prototype.get_time_entry_by_id = (id) => {
  this.request('GET', `/time_entries/${id}.json`, {});
};
 ...
 */
Redmine.prototype.create_time_entry = (params) => {
  this.request('POST', '/time_entries.json', params);
};
 ...
 */
Redmine.prototype.update_time_entry = (id, params) => {
  this.request('PUT', `/time_entries/${id}.json`, params);
};
 ...
 */
Redmine.prototype.delete_time_entry = (id) => {
  this.request('DELETE', `/time_entries/${id}.json`, {});
};
 ...
 */
Redmine.prototype.membership_by_project_id = (id, params) => {
  this.request('GET', `/projects/${id}/memberships.json`, params);
};
 ...
 */
Redmine.prototype.create_project_membership = (id, params) => {
  this.request('POST', `/projects/${id}/memberships.json`, params);
};
 ...
 */
Redmine.prototype.project_membership_by_id = (id, params) => {
  this.request('GET', `/memberships/${id}.json`, params);
};
 ...
 */
Redmine.prototype.update_project_membership = (id, params) => {
  this.request('PUT', `/memberships/${id}.json`, params);
};
 ...
 */
Redmine.prototype.delete_project_membership = (id) => {
  this.request('DELETE', `/memberships/${id}.json`, {});
};
 ...
 */
Redmine.prototype.issue_relation_by_issue_id = (id) => {
  this.request('GET', `/issues/${id}/relations.json`, {});
};
 ...
 */
Redmine.prototype.create_issue_relation = (id, params) => {
  this.request('POST', `/issues/${id}/relations.json`, params);
};
 ...
 */
Redmine.prototype.issue_relation_by_id = (id) => {
  this.request('GET', `/relations/${id}.json`, {});
};
 ...
 */
Redmine.prototype.delete_issue_relation = (id) => {
  this.request('DELETE', `/relations/${id}.json`, {});
};
 ...
 */
Redmine.prototype.news = (params) => {
  this.request('GET', '/news.json', params);
};
 ...
 */
Redmine.prototype.new_by_project_id = (id) => {
  this.request('GET', `/projects/${id}/news.json`, {});
};
 ...
 */
Redmine.prototype.version_by_project_id = (id) => {
  this.request('GET', `/projects/${id}/versions.json`, {});
};
 ...
 */
Redmine.prototype.create_version = (id, params) => {
  this.request('POST', `/projects/${id}/versions.json`, params);
};
 ...
 */
Redmine.prototype.version_by_id = (id) => {
  this.request('GET', `/versions/${id}.json`, {});
};
 ...
 */
Redmine.prototype.update_version = (id, params) => {
  this.request('PUT', `/versions/${id}.json`, params);
};
 ...
 */
Redmine.prototype.delete_version = (id) => {
  this.request('DELETE', `/versions/${id}.json`, {});
};
 ...
 */
Redmine.prototype.wiki_by_project_id = (id) => {
  this.request('GET', `/projects/${id}/wiki/index.json`, {});
};
 ...
 */
Redmine.prototype.wiki_by_title = (id, title, params) => {
  this.request('GET', `/projects/${id}/wiki/${title}.json`, params);
};
 ...
 */
Redmine.prototype.wiki_history_by_title = (id, title, version, params) => {
  this.request('GET', `/projects/${id}/wiki/${title}/${version}.json`, params);
};
 ...
 */
Redmine.prototype.create_wiki = (id, title, params) => {
  this.request('PUT', `/projects/${id}/wiki/${title}.json`, params);
};
 ...
 */
Redmine.prototype.delete_wiki = (id, title) => {
  this.request('DELETE', `/projects/${id}/wiki/${title}.json`, {});
};
 ...
 */
Redmine.prototype.queries = (params) => {
  this.request('GET', '/queries.json', params);
};
 ...
 */
Redmine.prototype.attachment_by_id = (id) => {
  this.request('GET', `/attachments/${id}.json`, {});
};
 ...
 */
Redmine.prototype.issue_statuses = () => {
  this.request('GET', '/issue_statuses.json', {});
};
 ...
 */
Redmine.prototype.trackers = () => {
  this.request('GET', '/trackers.json', {});
};
 ...
 */
Redmine.prototype.issue_priorities = () => {
  this.request('GET', '/enumerations/issue_priorities.json', {});
};
 ...
 */
Redmine.prototype.time_entry_activities = () => {
  this.request('GET', '/enumerations/time_entry_activities.json', {});
};
 ...
 */
Redmine.prototype.issue_categories_by_project_id = (id) => {
  this.request('GET', `/projects/${id}/issue_categories.json`, {});
};
 ...
 */
Redmine.prototype.create_issue_category = (id, params) => {
  this.request('POST', `/projects/${id}/issue_categories.json`, params);
};
 ...
 */
Redmine.prototype.issue_category_by_id = (id) => {
  this.request('GET', `/issue_categories/${id}.json`, {});
};
 ...
 */
Redmine.prototype.update_issue_category = (id, params) => {
  this.request('PUT', `/issue_categories/${id}.json`, params);
};
 ...
 * http://www.redmine.org/projects/redmine/wiki/Rest_IssueCategories#DELETE
 */
Redmine.prototype.delete_issue_category = (id) => {
  this.request('DELETE', `/issue_categories/${id}.json`, {});
};
 ...
 */
Redmine.prototype.roles = () => {
  this.request('GET', '/roles.json', {});
};
 ...
 */
Redmine.prototype.role_by_id = (id) => {
  this.request('GET', `/roles/${id}.json`, {});
};
 ...
 */
Redmine.prototype.groups = () => {
  this.request('GET', '/groups.json', {});
};
 ...
 */
Redmine.prototype.create_group = (params) => {
  this.request('POST', '/groups.json', params);
};
 ...
 */
Redmine.prototype.group_by_id = (id, params) => {
  this.request('GET', `/groups/${id}.json`, params);
};
 ...
 */
Redmine.prototype.update_group = (id, params) => {
  this.request('PUT', `/groups/${id}.json`, params);
};
 ...
 */
Redmine.prototype.delete_group = (id) => {
  this.request('DELETE', `/groups/${id}.json`, {});
};
 ...
 */
Redmine.prototype.add_user_to_group = (groupId, userId) => {
  const params = {
    userId,
  };
  this.request('POST', `/groups/${groupId}/users.json`, params);
};
 ...
 */
Redmine.prototype.remove_user_from_group = (groupId, userId) => {
  this.request('DELETE', `/groups/${groupId}/users/${userId}.json`, {});
};
 ...
 */
Redmine.prototype.custom_fields = () => {
  this.request('GET', '/custom_fields.json', {});
};
...
Redmine.prototype.upload = (content) => {
  this.request('POST', '/uploads.json', content);
};
